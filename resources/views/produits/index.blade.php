...
@endif
<a href="{{route('produits.create')}}" class="btn btn-primary m-3"> ADD PRODUIT</a>
            ...
            <tr>
                ...
                <td class="align-middle">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('produits.edit', $produit->ref)}}" type="button"
                            class="btn btn-warning">Edit</a>

                        <form action="{{ route('produits.destroy', $produit->ref) }}" method="POST" type="button"
                            class="btn btn-danger p-0 m-0" onsubmit="return confirm('Delete?')">
                            @csrf
                            @method('DELETE')
